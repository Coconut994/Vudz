...
file_path = "E:\\SARSA1\\travelling-salesman-problem-tsp\\dataset\\new data TSPD.txt" 
...
main.train()
with open("E:\\SARSA1\\travelling-salesman-problem-tsp\\result\\raw\\TspD_48.txt","a") as fio:
    fio.write(f'Truck route: {main.route_truck}\n')
    fio.write(f'Drone rpute: {main.route_drone}\n')
    fio.write(f'ans: {main.ans}\n\n')
